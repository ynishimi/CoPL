...
changes x = 2, y = 2 to x = 1, y = 0 by C-WhileT {
 ...
 while (0 < x && 0 < y) do if y < x then x := x - 1 else y := y - 1
 changes x = 2, y = 1 to x = 1, y = 0 by C-WhileT {
  ...
  while (0 < x && 0 < y) do if y < x then x := x - 1 else y := y - 1
  changes x = 1, y = 1 to x = 1, y = 0 by C-WhileT {
   ...
   while (0 < x && 0 < y) do if y < x then x := x - 1 else y := y - 1
   changes x = 1, y = 0 to x = 1, y = 0 by C-WhileF {
